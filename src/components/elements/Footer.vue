<template>
  ...
  <footer class="bg-forest-500 shadow">
    <div class="w-full container mx-auto p-4 md:px-6 md:py-8">

      <div class="w-full flex flex-row items-center justify-between">

        <router-link id="footer-logo" class="shrink-0" :to="{ name: 'home' }">
          <img class="logo-img" :src="logoWhite" alt="Terra Cognita Logo">
        </router-link> 

        <div class="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
          <a href="#" target="_blank" class="text-sand-900">
            <EnvelopeIcon class="icon"/>
            <span class="sr-only">Email page</span>
          </a>
          <a href="https://twitter.com/TCog1576" target="_blank" class="text-sand-900">
          ...
          <a href="https://github.com/Terra-Cognita" target="_blank" class="text-sand-900">
      ...
      <span class="block text-xs text-sand-100 text-center">© Terra Cognita 2023. The land of discovery.</span>
    </div>
  </footer>
</template>
